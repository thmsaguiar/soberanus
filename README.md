![Banner](https://github.com/thmsaguiar/soberanus/blob/main/src/assets/img/banner.png?raw=true)

![GitHub repo size](https://img.shields.io/github/repo-size/thmsaguiar/soberanus)
...
Uma nova forma de atender a pedidos e realizar pagamentos.
...
O projeto foi pensado para que os garçons da hamburgueria possam usar no smartphone, iPod ou Palmo, modernizando e agilizando os processos. O app será usado para fazer o pedido dos clientes no conforto da mesa, controle e consulta da conta, mostrando os pedidos já feitos e o valor total com e sem a taxa de serviço. Cada garçom terá uma senha e por isso terá um login e senha como requisito para entrar na aplicação.

### <a name="home">01. Home</a>
